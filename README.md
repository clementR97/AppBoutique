...
![Changement des carts](./screenshots/accueil-category.png)

### alert ajout d'article
![alert ajouter](./screenshots/alert-ajouter.png)

### modal a propos
![modal infos article](./screenshots/modal-about.png)

### modal panier
![modal panier](./screenshots/modal-bag.png)
